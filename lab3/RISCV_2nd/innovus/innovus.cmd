...
#  Created on Sat Feb 20 20:42:17 2021                
#                                                     
#######################################################
...
read_activity_file -format VCD -scope /RISCV_tb/UUT -start {} -end {} -block {} ../vcd_innovus/RISCV_innovus.vcd
set_power -reset
set_powerup_analysis -reset
set_dynamic_power_simulation -reset
report_power -rail_analysis_format VS -outfile .//RISCV.rpt
gui_select -rect {45.617 122.502 48.755 122.502}
